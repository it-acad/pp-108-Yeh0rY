...
class Author(models.Model):
    ...
    date_of_birth = models.DateField(null=True, blank=True)  # Nullable and optional field
    date_of_death = models.DateField(null=True, blank=True)  # Nullable and optional field
